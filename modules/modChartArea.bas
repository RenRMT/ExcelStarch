...
'   Area100Chart — xlAreaStacked100: all series stacked to 100% of the category total
'
' Both variants use the full FILL pipeline. AxisBetweenCategories = False so areas
