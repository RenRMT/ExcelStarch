Attribute VB_Name = "modChartDonut"
Option Explicit
...
Private Sub BuildDonutChart()
    ...
    ' Donut-specific pipeline (no generic ApplyChartPipeline — donut has no axes/gridlines)
    InsertLogo cht
    InsertSource cht
    SetDonutChartSizeandTitle cht
    ...
    Else
        ...
        For i = 1 To pointscount
            ApplyDonutSliceColor cht, i, palette(i)
        Next i
    End If
End Sub


Private Sub ApplyDonutSliceColor(cht As Chart, ByVal idx As Long, ByVal clr As Long)
...
Private Sub SetDonutChartSizeandTitle(cht As Chart)
    ...
    ' Size the donut chart plot area
    ...
    ' Center donut chart horizontally
